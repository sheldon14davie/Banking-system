    ...
    <div className="bg-white rounded-lg shadow">
      <div className="p-6 border-b">
        ...
        <p className="text-sm text-gray-600">
          View all system-wide transactions for auditing
        </p>
      </div>
      <div className="p-6">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-left py-3 px-4 text-sm">From Account</th>
                  <th className="text-left py-3 px-4 text-sm">To Account</th>
              ...
              <tbody>
                {transactions.map((transaction) => (
                  <tr key={transaction.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-sm">
                      {transaction.receiver_account_id ? `#${transaction.receiver_account_id}` : '-'}
                    </td>
